...
public class RecievePacketContent extends PacketContent {
    String t ;
    String l ;
    String v ;
    String tlv ;
	...
	RecievePacketContent(String t, String l, String v ,String tlv ,  String info) {
		type= RECIEVE;
		this.t = t;
        this.l = l ;
        this.v = v ;
	 ...
	 */
    protected RecievePacketContent(ObjectInputStream oin) {
		try {
			type= RECIEVE;
            t = oin.readUTF();
            l = oin.readUTF();
	 ...
	 *
	 * @return Returns the type contained in the packet.
	 */
	 ...
	 *
	 * @return Returns the length contained in the packet.
	 */
